/**
 * Aplica la migración 20260528_serie_cpe_drop_activa a todos los schemas tenant_*.
 *
 *   Uso: pnpm exec tsx scripts/aplicar-migracion-serie-cpe-drop-activa.ts
 *        pnpm exec tsx scripts/aplicar-migracion-serie-cpe-drop-activa.ts --tenant tenant_mi_tienda
 */
...
const SQL_PATH = join(
  ...
  'prisma',
  'migrations',
  '20260528_serie_cpe_drop_activa',
  'migration.sql',
);
