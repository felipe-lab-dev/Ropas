/**
 * Aplica la migración 20260526_facturacion_sunat (facturación electrónica SUNAT)
 * a todos los schemas tenant_* (o solo al tenant indicado con --tenant <name>).
 *
 *   Uso: pnpm exec tsx scripts/aplicar-migracion-facturacion.ts
 *        pnpm exec tsx scripts/aplicar-migracion-facturacion.ts --tenant tenant_mi_tienda
 */
...
async function main() {
  ...
  console.log('');
  console.log(`✅ Facturación SUNAT: migración completada.`);
