...
- Name: 03-aplicar-en-venta.spec.ts >> Cupones · aplicación end-to-end en venta >> crea cupón → aplica en POS → confirma venta → ve canje en detalle
- Location: e2e\03-aplicar-en-venta.spec.ts:9:7
