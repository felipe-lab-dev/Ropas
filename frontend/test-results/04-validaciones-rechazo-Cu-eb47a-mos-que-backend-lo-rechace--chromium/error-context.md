...
- Name: 04-validaciones-rechazo.spec.ts >> Cupones · validaciones y rechazos >> canjear: cupón vencido no se acepta (creamos uno con fechas pasadas vía formulario y dejamos que backend lo rechace)
- Location: e2e\04-validaciones-rechazo.spec.ts:44:7
