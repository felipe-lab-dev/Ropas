 ...
 *
 * Uso:
 *   node scripts/kill-puerto.mjs 3000
 *
 * Necesario en Windows: Stop-Process / Ctrl+C de pnpm dev NO mata a los
 * procesos hijos (next dev, nest start --watch, ng serve), que quedan
 * vivos ocupando el puerto. Este script los limpia antes de cada `pnpm dev`
 * vía el hook `predev`.
 *
