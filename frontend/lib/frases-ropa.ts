...
export const FRASES_ROPA: FraseRopa[] = [
  ...
  { categoria: 'tip', texto: 'Etiqueta cada variante con código de barras: las ventas se aceleran 3x con escáner en el POS.' },
  ...
  { categoria: 'tip', texto: 'Repón el stock mínimo antes de que un best-seller se agote: pierdes más por quiebre que por exceso.' },
  ...
  { categoria: 'tip', texto: 'Cobra con Yape/Plin: en Perú representan el 40% de los pagos retail bajo S/ 100.' },
  { categoria: 'dato', texto: 'El 73% de los compradores de ropa revisan stock online antes de visitar la tienda física.' },
  { categoria: 'curiosidad', texto: 'La talla M peruana equivale aprox. a una talla 38-40 europea — verifica tus tablas.' },
  { categoria: 'tip', texto: 'Combina productos complementarios en el POS para aumentar el ticket promedio (cross-selling).' },
  { categoria: 'dato', texto: 'Las tiendas con WhatsApp Business venden 27% más que las que solo dependen del local físico.' },
  { categoria: 'curiosidad', texto: 'En el sector retail, el martes y miércoles son los días con menos ventas — úsalos para inventariar.' },
  { categoria: 'tip', texto: 'Cierra caja cada turno con arqueo: diferencias por encima de S/ 10 indican fugas o errores recurrentes.' },
  { categoria: 'dato', texto: 'El cliente recurrente gasta 67% más que uno nuevo. Construye tu base de clientes desde el primer ticket.' },
